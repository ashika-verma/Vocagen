...
class ParticleEditor(App):
    ...
    def build(self):
        ...
        self.ps = ViewPanel()
        self.panels = [ParticleConfigPanel(self.ps),EmitterConfigPanel(self.ps),GeneralPanel(self.ps, on_new_config=self.on_new_config, on_randomize=self.on_randomize),StartColorPanel(self.ps),EndColorPanel(self.ps)]
